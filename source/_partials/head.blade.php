...
@if($page->use_fancybox)
    ...
    <script type="text/javascript" src="{{ $page->baseUrl }}/assets/js/fancybox/source/helpers/jquery.fancybox-thumbsf2ad.js?v=1.0.7"></script>
@endif

@if($page->use_flickity)
    <!-- Flickity -->
    <link rel="stylesheet" href="{{ $page->baseUrl }}/assets/css/flickity.css" type="text/css" media="screen" />
    <script type="text/javascript" src="{{ $page->baseUrl }}/assets/js/flickity.pkgd.min.js"></script>
@endif
